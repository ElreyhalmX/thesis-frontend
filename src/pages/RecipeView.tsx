...
export default function RecipeView() {
  ...
  const handleMarkCooked = () => {
    ...
    // Simulate savings: Restaurant ($20) - Home ($5) = $15 saved per serving * servings
    // User feedback: Street food is expensive (> $8). Using conservative $15 saving.
    const estimatedSavings = 15 * recipe.servings;
